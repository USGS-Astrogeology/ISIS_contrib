...
todir="reproj_pixres"
dndir="reproj"
pixresdir="reproj_pixres"

echo $dndir/$basename"_reproj.cub" > $todir/$basename".lis"
echo $pixresdir/$basename"reproj_pixres.cub" >> $todir/$basename".lis"

# Mask the image
cubeit fromlist=$todir/$basename".lis" to=$todir/$basename".cub"
