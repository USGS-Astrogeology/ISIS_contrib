...
#For DEM, "add" with hillshade (optional
...
#isis2std red=R.cub green=G.cub blue=B.cub to=RGB.tif mode=rgb format=tiff minpercent=0 maxpercent=100 quality=90
#gdal_copylabel.py RGB.tif RGB.cub RGB.vrt
#gdal_translate -co compress=lzw -co tiled=YES RGB.vrt RGB_geo.tif
#/bin/rm -f RGB.tif
#/bin/rm -f RGB.vrt
